...
managerRoute.patch("/employee/:id", manageController_1.default.userEdit);
...
managerRoute.get("/getAllEmployees", manageController_1.default.getAllEmployees);
managerRoute.get("/getAllRequests/:id", manageController_1.default.getAllRequests);
